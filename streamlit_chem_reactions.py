...
st.sidebar.markdown("- Arndt Eistert reaction")
st.sidebar.markdown("- Hofmann Martius rearrangement ")
st.sidebar.markdown("- Darzens reaction")
st.sidebar.markdown("- Pinacol Coupling Reaction")
st.sidebar.markdown("-Pinacol rearrangement")
st.sidebar.divider()
